    ...
    def show_provider_settings_menu(self):
        ...
        if credentials:
            for provider, info in credentials.items():
                ...
                self.console.print(f"   ✅ {provider_name:15} ({display})")
        else:
            self.console.print("   • No providers configured")
        ...
        if custom_bases:
            ...
            self.console.print("━" * 70)
            for provider, url in custom_bases.items():
                self.console.print(f"   • {provider:15} {url}")
        else:
            self.console.print("\n[bold]🌐 Custom API Bases[/bold]")
            self.console.print("━" * 70)
            self.console.print("   • No custom API bases configured")

        # Model Definitions
        if model_defs:
            self.console.print()
            self.console.print("[bold]📝 Custom Model Definitions[/bold]")
            self.console.print("━" * 70)
            for provider, count in model_defs.items():
                self.console.print(f"   • {provider:15} {count} models defined")
        else:
            self.console.print("\n[bold]📝 Custom Model Definitions[/bold]")
            self.console.print("━" * 70)
            self.console.print("   • No custom model definitions")
